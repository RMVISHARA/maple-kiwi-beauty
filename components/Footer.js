        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="https://www.facebook.com/share/19FtXGgFUi/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#FAF7F2]/5 hover:bg-brand-rose hover:text-[#FAF7F2] rounded-full transition-all text-[#FAF7F2]/60" aria-label="Facebook">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/maple.kiwibeauty?igsh=MXg3MjJ0dmsxamJwdg==" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#FAF7F2]/5 hover:bg-brand-rose hover:text-[#FAF7F2] rounded-full transition-all text-[#FAF7F2]/60" aria-label="Instagram">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
